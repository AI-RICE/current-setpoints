...
def plot_grid_segments(data_obj: Any, machine: Optional[BaseMachine] = None) -> None:
    """
...
def plot_current_trajectories_split(
    dict_grid_base: Dict[str, Any], dict_grid_recalc: Dict[str, Any], machine: BaseMachine
) -> None:
    colors_map = PlotConfig.get_colors()
    labels_map = PlotConfig.get_labels()
