...
def current_constraint(omega: float, curr_dq: np.ndarray, curr_max: float, transform: BaseTransform) -> float:
    """
...
def voltage_constraint(omega: float, curr_dq: np.ndarray, volt_max: float, transform: BaseTransform) -> float:
    """
